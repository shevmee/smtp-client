...
class SmtpClient {
 public:
  ...
  future<void> AsyncAuthenticate(const string &username,
 ...
 private:
  ...
  bool AsyncSendMailFromCmd(const ISXMM::MailAddress &mail_message,
                            asio::yield_context &yield);
  bool AsyncSendRcptToCmd(const ISXMM::MailAddress &mail_address,
                          asio::yield_context &yield);
